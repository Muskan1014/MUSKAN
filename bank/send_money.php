...
<body style="background-color:orange; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px black;">
