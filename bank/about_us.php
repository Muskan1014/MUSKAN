...
<body style="background-color:orange;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/Muskan.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Muskan KUMARI</h1>
            <p style="color:black;"><b>Intern at Sparks Foundation <br> JYOTI NIVAS COLLEGE AUTONOMOUS</b></p>
    </center>
