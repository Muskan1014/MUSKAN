...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logo.jpg" alt=""
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:orange;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-family: Stencil;size:0px; text-shadow:3px 3px 3px red; text-align:center;"><b>Spark bank <br> of
                        India!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/bankpic.jpg" class="zoomin" alt="" style="width:200px;">
            </div>
        </div>
    </div>
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:orange; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
